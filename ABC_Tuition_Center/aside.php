	...
	<?php 
		...
		if($_SESSION['usertype'] == 'admin'){ ?>
			...
			<ul class=" hide-on-med-and-down section table-of-contents" >
	          ...
	          <a class="white-text" href="mailto:tech@abctuitioncentre.com">tech@abctuitioncentre.com</a>
	...
	<?php 	} //end if
		...
		if($_SESSION['usertype'] == 'lecturer'){ ?>
			...
			<ul class=" hide-on-med-and-down section table-of-contents" >
      		...
      		<br>
      		<p class="white-text">For technical issues, contact: </p>
	        <a class="white-text" href="mailto:tech@abctuitioncentre.com">tech@abctuitioncentre.com</a><!--Emergency Contact-->      		
