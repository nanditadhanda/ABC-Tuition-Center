...
$PageTitle="Student Portal - ABC Tuition Centre"; //page title
					...
					<a href="studentprofile.php">
						<div class="card ">
					        <div class="card-content align-center">
					          ...
					          <h5 class=" fontw-500 color-green">My Profile</h5> <!--thumbnail title-->	
					        </div>
					    </div>
					</a>
				</div>
							...
							<div class="col s12 m6 l8">
								<div class="card ">
							        <div class="card-content align-center">	      
							          	...
							          	<p>Thank you for registering with ABC Tuition Centre. Your registration status is still pending. You will be able to enroll for courses once your application is approved by the administration.</p>
							          	<br/>
							          	<p >For further enquires please contact: <a href="mailto:admin@abctuitioncentre.com">admin@abctuitioncentre.com</a></p>		
							        </div>
							    </div>
							</div>
