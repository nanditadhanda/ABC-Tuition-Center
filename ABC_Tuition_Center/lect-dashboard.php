<?php
//lecturer dashboard
$PageTitle="Lecturer Dashboard - ABC Tuition Centre"; //page title
					...
					<div class="card margin-top-40">
						...
						<?php
								...
								<div  class=' align-center width-full	'>	
									...
									<a class="waves-effect waves-light margin-top-20 "  href="mailto:admin@abctuitioncentre.com" >admin@abctuitioncentre.com</a>
								</div>	
						<?php
							} //end else	?>
					</div> <!--card flex-->
