			...
			<div class=" card sticky-action ">
		        ...
		        <div class="card-content">
		        	<div class="row margin-0">
		        		<span class="card-title activator"><?php echo $row['cName'];?><i class="material-icons right">more_vert</i></span><!--course name-->
		        		<div class="col s12">
						...
						<div class="col s12 ">	
							<p ><a href="viewcourse.php?id=<?php echo $row['cID'];?>">Learn More</a></p>
